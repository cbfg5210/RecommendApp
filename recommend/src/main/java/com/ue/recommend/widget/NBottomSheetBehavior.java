...
/**
 * An interaction behavior plugin for a child view of {@link CoordinatorLayout} to make itwork as
 * a bottom sheet.
 */
public class NBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public static <V extends View> NBottomSheetBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof NBottomSheetBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with NBottomSheetBehavior");
        }
        return (NBottomSheetBehavior<V>) behavior;
    }
